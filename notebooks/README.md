...
This folder contains beginner-friendly notebooks for the downstream plan-validity repository.
...
- `03_downstream_training_demo.ipynb`: trains a small CPU-only scikit-learn MLP on the included features. The official repository training path is still `code/downstream/train_validity.py`.
